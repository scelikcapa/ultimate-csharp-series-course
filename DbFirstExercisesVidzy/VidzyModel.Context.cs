...
namespace DbFirstExercisesVidzy
{
    ...
    public partial class VidzyContext : DbContext
    {
        ...
        public virtual int AddVideo(string name, Nullable<System.DateTime> releaseDate, string genre, Nullable<DbFirstExercisesVidzy.Classification> classification)
        {
            ...
            var classificationParameter = classification.HasValue ?
                ...
                new ObjectParameter("Classification", typeof(DbFirstExercisesVidzy.Classification));
